...
import type { Cell as _Cell, Error as _Error, Result as _Result, Result__1 as _Result__1, SavedRun as _SavedRun, UserRole as _UserRole, Value as _Value } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getMyRuns(arg0: Array<bigint>): Promise<Array<SavedRun>> {
        if (this.processError) {
            try {
    ...
    async listMyRunSummaries(): Promise<Array<SavedRunSummary>> {
        if (this.processError) {
            try {
    ...
    async listMyRuns(): Promise<Array<SavedRun>> {
        if (this.processError) {
            try {
...
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_SavedRun]): SavedRun | null {
